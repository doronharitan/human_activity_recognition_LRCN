...
parser.add_argument('--num_frames_to_extract', default=5, type=int, help='')
...
def main():
    ...
    for file_name in os.listdir(arg.ucf_list_dir):
        ...
        with open(arg.ucf_list_dir + file_name) as f:
        ...
        # with tqdm_notebook(total=len(dataloader)) as pbar:
            for video_name in video_list:
                ...
                video = cv2.VideoCapture(arg.row_data_dir + video_name)
